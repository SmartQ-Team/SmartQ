...
class QueueEntry(models.Model):
    ...
    service = models.ForeignKey(
        'services.Service', on_delete=models.CASCADE, related_name='queue_entries'
    )
    ...
    running_late = models.BooleanField(default=False)
    ...
    counter = models.ForeignKey(
        'services.Counter', on_delete=models.SET_NULL, null=True, blank=True,
